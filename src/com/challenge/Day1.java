...
public class Day1 {
    ...
    public static void main(String[] args) {
        ...
        long totalFuel = new Day1().calculateTotalFuel(getInput());
        System.out.println("Answer: " + totalFuel);

        //new Day1().doTests();
    }

    public long calculateTotalFuel(List<Integer> modulesMass) {
        long totalFuel = 0L;

        for(Integer mass : modulesMass) {
    ...
    private long calculateFuel(long mass) {
        long fuel = simpleFuelCalculation(mass);
        if (fuel > 0)
    ...
    private long simpleFuelCalculation(long mass) {
        long fuel = mass/3 - 2;
    ...
    public void doTests() {
        ...
        for(int i : masses) {
            System.out.println("Fuel for mass of i: " + calculateFuel(i));
        }
    }
